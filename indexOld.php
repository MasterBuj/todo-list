...
<html>
  ...
  <body>
    <div class="d-flex flex-wrap justify-content-around">
      ...
      <div class="  p-2 rounded bg-white mt-5">
        <form action="" class="input-group-append" method="post" autocomplete="off">
          <div class="input-group mb-3">

            <input required type="text"
              value="<?= isset($_GET['action']) && $_GET['action'] == 'edit' ? $_GET['todo'] : ''; ?>" name="task"
              class="form-control" name id="task" placeholder="write a task ...">
            ...
            <div class="input-group-append">
              ...
              <input type="hidden" type="submit"
                value="<?= isset($_GET['action']) && $_GET['action'] == 'edit' ? $_GET['id'] : ''; ?>" name="task_id" />
            </div>
          </div>
        </form>
      </div>
      ...
      <div class="list-group  p-2 rounded bg-white  mt-5">
        <h3>Done: </h3>
